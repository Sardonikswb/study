    ...
    <div class="row">
        <table class="table table-striped table-bordered col-md-4">
           ...
           <c:forEach items="${mobilesList}" var="mobile">
                <tr>
                    <td>${mobile.value.model}</td>
                    <td>${mobile.value.cost}</td>
                    <td><a href="${pageContext.request.contextPath}/edit?id=${mobile.value.id}">Edit</a></td>
                    <td><a href="${pageContext.request.contextPath}/delete?id=${mobile.value.id}">Delete</a></td>
                </tr>
            </c:forEach>
        </table>
